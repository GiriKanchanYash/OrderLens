"""
LLM service for OrderLens Analytics.
...
def load_schema_from_yaml(yaml_path: str | None = None) -> str:
    ...
    try:
        ...
        return (
            ...
            f"DATABASE: {Config.FABRIC_ORDERLENS_DATABASE}\nSCHEMA: {Config.SCHEMA}\n"
    ...
    prompt = textwrap.dedent(f"""
        ...
        DATABASE: {Config.FABRIC_ORDERLENS_DATABASE}
        SCHEMA: {Config.SCHEMA}
    ...
    for table in schema_data.get("tables", []):
        ...
        for measure in table.get("measures", []):
            ...
            dtype = measure.get("data_type", "decimal")
    ...
    prompt += textwrap.dedent("""
        ...
        OUTPUT FORMAT (ABSOLUTE RULE):
          ...
          - If the question is vague or conversational, return exactly:
            SELECT 'Please ask a specific question about dealers, products, orders, or order status,Inventory.' AS MESSAGE
    ...
    try:
        ...
        if not (sql_upper.startswith("SELECT") or sql_upper.startswith("WITH")):
            ...
            if match:
                ...
                sql = (
                    "SELECT 'Please ask a specific question about Orders, "
                    "Parts, Inventory.' AS MESSAGE"
                )
